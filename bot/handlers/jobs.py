...
@router.message(
    ...
    # F.text in ArticleDB.get_adult_jobs_names())

    lambda message: UserDB.get_user_age(message.from_user.username) == 30 and message.text in ArticleDB.get_adult_jobs_names(),
    StateFilter(None)
)
...
@router.message(
    ...
    lambda message: UserDB.get_user_age(message.from_user.username) == 20 and message.text in ArticleDB.get_child_jobs_names(),
    StateFilter(None)
)
